...
export default function ArticlesPage() {
  ...
  const lawDefinitions: LawCategory = {
    '憲法': [
      { id: 'A0000001', name: '中華民國憲法' },
      { id: 'A0000002', name: '憲法增修條文' },
      { id: 'A0000003', name: '司法院大法官憲法解釋' },
    ],
    '民事法': [
      { id: 'A0000004', name: '民法' },
      { id: 'A0000005', name: '民事訴訟法' },
      { id: 'A0000006', name: '家事事件法' },
      { id: 'A0000007', name: '強制執行法' },
      { id: 'A0000008', name: '涉外民事法律適用法' },
      { id: 'A0000009', name: '非訟事件法' },
      { id: 'A0000010', name: '仲裁法' },
    ],
    '刑事法': [
      { id: 'A0000012', name: '中華民國刑法' },
      { id: 'A0000013', name: '刑事訴訟法' },
      { id: 'A0000014', name: '刑事補償法' },
      { id: 'A0000015', name: '性侵害犯罪防治法' },
    ],
    '行政法': [
      { id: 'A0000016', name: '行政程序法' },
      { id: 'A0000017', name: '行政訴訟法' },
      { id: 'A0000018', name: '行政罰法' },
      { id: 'A0000019', name: '行政執行法' },
      { id: 'A0000020', name: '訴願法' },
      { id: 'A0000021', name: '國家賠償法' },
      { id: 'A0000022', name: '地方制度法' },
    ],
    '商事法': [
      { id: 'A0000024', name: '公司法' },
      { id: 'A0000025', name: '保險法' },
      { id: 'A0000026', name: '票據法' },
      { id: 'A0000027', name: '證券交易法' },
      { id: 'A0000028', name: '海商法' },
    ],
    '司法制度': [
      { id: 'A0000030', name: '法院組織法' },
      { id: 'A0000031', name: '法官法' },
      { id: 'A0000032', name: '律師法' },
    ],
    '勞動與社會法': [
      { id: 'A0000033', name: '勞動基準法' },
      { id: 'A0000034', name: '勞工保險條例' },
      { id: 'A0000035', name: '性別平等工作法' },
      { id: 'A0000036', name: '消費者保護法' },
    ],
    '土地與不動產': [
      { id: 'A0000037', name: '土地法' },
      { id: 'A0000038', name: '土地徵收條例' },
      { id: 'A0000039', name: '都市計畫法' },
    ],
    '智慧財產': [
      { id: 'A0000040', name: '著作權法' },
      { id: 'A0000041', name: '商標法' },
      { id: 'A0000042', name: '專利法' },
    ],
  };
